...
+ (void)showWithText:(NSString *)text_{
    [TotastView showWithText:text_ duration:20];
}

+ (void)showWithText:(NSString *)text_
            duration:(CGFloat)duration_{
    TotastView *toast = [[TotastView alloc] initWithText:text_];
...
+ (void)showWithText:(NSString *)text_
    ...
    [TotastView showWithText:text_  topOffset:topOffset_ duration:Kduration];
}
...
+ (void)showWithText:(NSString *)text_
    ...
    [TotastView showWithText:text_  bottomOffset:bottomOffset_ duration:Kduration];
}
