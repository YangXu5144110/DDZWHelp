...
@interface JXPageListView () <JXPagerListContainerViewDelegate, JXCategoryViewDelegate>
...
@property (nonatomic, strong) UICollectionViewCell *listContainerCell;
...
- (void)initializeViews {
    ...
    self.pinCategoryView.titleSelectedColor = APPTintColor;
    ...
    self.pinCategoryView.averageCellSpacingEnabled = YES;
//    self.pinCategoryView.cellWidth = 65;
...
//    lineView.indicatorLineWidth = 30;
    ...
    _mainTableView = [[JXPageListMainTableView alloc] initWithFrame:CGRectZero collectionViewLayout:layout];
    [self.mainTableView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:kListContainerCellIdentifier];
...
- (UICollectionViewCell *)listContainerCellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UICollectionViewCell *cell = [self.mainTableView dequeueReusableCellWithReuseIdentifier:kListContainerCellIdentifier forIndexPath:indexPath];
